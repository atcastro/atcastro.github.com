(function(){
    ...
    function throwDice(){
        ...
        if( gameData.rollSum === 2 ){
            gameData.roundSum = 0;
            roundScore.innerHTML = `<p>${gameData.roundSum}!</p>`;
        ...
        // if either die is a 1...
            ...
            gameData.score[gameData.index] = gameData.score[gameData.index]- gameData.roundSum;
            gameData.roundSum = 0;
        ...
        // if neither die is a 1...
            ...
            gameData.roundSum = gameData.roundSum + gameData.rollSum;
            roundScore.innerHTML = `<p>${gameData.roundSum}!</p>`;
